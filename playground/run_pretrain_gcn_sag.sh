...
SCRIPT_NAME="run_pretrain_GCN_sag" # all gcn are trained with dataloader
...
python pretrain_GCN_network.py --name $RUN_NAME --pool-type $POOL_TYPE --num-epochs $NUM_EPOCHS --num-workers $NUM_WORKERS --sag-ratio 0.5
